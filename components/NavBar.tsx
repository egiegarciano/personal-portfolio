  ...
  return (
    <nav className='relative'>
      ...
      <div className='relative flex h-[100px] items-center justify-between px-6 md:px-[50px]'>
        ...
        >
          <div className='flex w-[260px] flex-col items-center space-y-7 bg-[#0F1624] pt-[100px] text-base font-medium tracking-wider lg:w-auto lg:flex-row lg:space-y-0 lg:space-x-7 lg:bg-transparent lg:pt-0 lg:pr-[50px]'>
